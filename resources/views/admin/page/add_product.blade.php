...
@section('titleadmin', 'Thêm sản phẩm')
            ...
            <div class="left">
                <div class="pd-2">
                    ...
                    <select name="parent_id" id="">
                        ...
                        {!! $category->categoryParent($categories) !!}
                    </select>
                    <label for="">Slug:</label>
                    <input type="text" min="0" name="slug" value="">
                ...
                <div class="form-group">
                    <div class="pd-2">
                        ...
                        <input type="" name="price_sale" value="">
                ...
                <div class="pd-2">
                    <label for="image-input">Ảnh mô tả:</label>
